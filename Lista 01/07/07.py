...
if stg1 == stg2:                                                    #Estrura condicional que vai verificar se as strings são iguais.
    print("As strings tem o mesmo tamanho e o mesmo conteudo!")     #imprime a mensagem resultado
    ...
    print("As strings tem o mesmo tamanho, porem contudo diferente!") #imprime a mensagem resultado
else:                                                                 #Estrura condicional para caso as strings sejam totalmente diferentes.
    print("As estrings não são iguais!")                              #imprime a mensagem resultado
